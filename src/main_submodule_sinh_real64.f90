...
!! @note
!! [main_submodule_sinh_real64.f90](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/src/main_submodule_sinh_real64.f90)
!! [demo_sinh_error_real64.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_sinh_error_real64.svg)
!! [demo_sinh_series_real64.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_sinh_series_real64.svg)
!! @endnote
