...
!! @note
!! [main_submodule_exp_real64.f90](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/src/main_submodule_exp_real64.f90)
!! [demo_exp_error_real64.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_exp_error_real64.svg)
!! [demo_exp_series_real64.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_exp_series_real64.svg)
!! @endnote
