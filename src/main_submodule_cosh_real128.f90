!> Implementation of `taylor_series_cosh_***` for `real128`.
!! @note
!! [main_submodule_cosh_real128.f90](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/src/main_submodule_cosh_real128.f90)
!! [demo_cosh_error_real128.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_cosh_error_real128.svg)
!! [demo_cosh_series_real128.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_cosh_series_real128.svg)
!! @endnote
submodule (taylor_series_fortran) imp_taylor_series_cosh_real128
    ...
    module procedure taylor_series_cosh_000_real128

        res = horner_000( x = x, pre_step = 0.0_real128 )

    end procedure taylor_series_cosh_000_real128


    module procedure taylor_series_cosh_001_real128

        res = taylor_series_cosh_000_real128(x)

    end procedure taylor_series_cosh_001_real128


    module procedure taylor_series_cosh_002_real128

        res = horner_001( x = x, pre_step = coefficient_002 )

    end procedure taylor_series_cosh_002_real128


    module procedure taylor_series_cosh_003_real128

        res = taylor_series_cosh_002_real128(x)

    end procedure taylor_series_cosh_003_real128


    module procedure taylor_series_cosh_004_real128

        res = horner_003( x = x, pre_step = coefficient_004 )

    end procedure taylor_series_cosh_004_real128


    module procedure taylor_series_cosh_005_real128

        res = taylor_series_cosh_004_real128(x)

    end procedure taylor_series_cosh_005_real128


    module procedure taylor_series_cosh_006_real128

        res = horner_005( x = x, pre_step = coefficient_006 )

    end procedure taylor_series_cosh_006_real128


    module procedure taylor_series_cosh_007_real128

        res = taylor_series_cosh_006_real128(x)

    end procedure taylor_series_cosh_007_real128


    module procedure taylor_series_cosh_008_real128

        res = horner_007( x = x, pre_step = coefficient_008 )

    end procedure taylor_series_cosh_008_real128


    module procedure taylor_series_cosh_009_real128

        res = taylor_series_cosh_008_real128(x)

    end procedure taylor_series_cosh_009_real128


    module procedure taylor_series_cosh_010_real128

        res = horner_009( x = x, pre_step = coefficient_010 )

    end procedure taylor_series_cosh_010_real128


    module procedure taylor_series_cosh_011_real128

        res = taylor_series_cosh_010_real128(x)

    end procedure taylor_series_cosh_011_real128


    module procedure taylor_series_cosh_012_real128

        res = horner_011( x = x, pre_step = coefficient_012 )

    end procedure taylor_series_cosh_012_real128


    module procedure taylor_series_cosh_013_real128

        res = taylor_series_cosh_012_real128(x)

    end procedure taylor_series_cosh_013_real128


    module procedure taylor_series_cosh_014_real128

        res = horner_013( x = x, pre_step = coefficient_014 )

    end procedure taylor_series_cosh_014_real128


    module procedure taylor_series_cosh_015_real128

        res = taylor_series_cosh_014_real128(x)

    end procedure taylor_series_cosh_015_real128


    module procedure taylor_series_cosh_016_real128

        res = horner_015( x = x, pre_step = coefficient_016 )

    end procedure taylor_series_cosh_016_real128


    module procedure taylor_series_cosh_017_real128

        res = taylor_series_cosh_016_real128(x)

    end procedure taylor_series_cosh_017_real128


    module procedure taylor_series_cosh_018_real128

        res = horner_017( x = x, pre_step = coefficient_018 )

    end procedure taylor_series_cosh_018_real128


    module procedure taylor_series_cosh_019_real128

        res = taylor_series_cosh_018_real128(x)

    end procedure taylor_series_cosh_019_real128


    module procedure taylor_series_cosh_020_real128

        res = horner_019( x = x, pre_step = coefficient_020 )

    end procedure taylor_series_cosh_020_real128


    module procedure taylor_series_cosh_021_real128

        res = taylor_series_cosh_020_real128(x)

    end procedure taylor_series_cosh_021_real128


    module procedure taylor_series_cosh_022_real128

        res = horner_021( x = x, pre_step = coefficient_022 )

    end procedure taylor_series_cosh_022_real128


    module procedure taylor_series_cosh_023_real128

        res = taylor_series_cosh_022_real128(x)

    end procedure taylor_series_cosh_023_real128


    module procedure taylor_series_cosh_024_real128

        res = horner_023( x = x, pre_step = coefficient_024 )

    end procedure taylor_series_cosh_024_real128


    module procedure taylor_series_cosh_025_real128

        res = taylor_series_cosh_024_real128(x)

    end procedure taylor_series_cosh_025_real128


    module procedure taylor_series_cosh_026_real128

        res = horner_025( x = x, pre_step = coefficient_026 )

    end procedure taylor_series_cosh_026_real128


    module procedure taylor_series_cosh_027_real128

        res = taylor_series_cosh_026_real128(x)

    end procedure taylor_series_cosh_027_real128


    module procedure taylor_series_cosh_028_real128

        res = horner_027( x = x, pre_step = coefficient_028 )

    end procedure taylor_series_cosh_028_real128


    module procedure taylor_series_cosh_029_real128

        res = taylor_series_cosh_028_real128(x)

    end procedure taylor_series_cosh_029_real128


    module procedure taylor_series_cosh_030_real128

        res = horner_029( x = x, pre_step = coefficient_030 )

    end procedure taylor_series_cosh_030_real128


    module procedure taylor_series_cosh_031_real128

        res = taylor_series_cosh_030_real128(x)

    end procedure taylor_series_cosh_031_real128


    module procedure taylor_series_cosh_032_real128

        res = horner_031( x = x, pre_step = coefficient_032 )

    end procedure taylor_series_cosh_032_real128


    module procedure taylor_series_cosh_033_real128

        res = taylor_series_cosh_032_real128(x)

    end procedure taylor_series_cosh_033_real128


    module procedure taylor_series_cosh_034_real128

        res = horner_033( x = x, pre_step = coefficient_034 )

    end procedure taylor_series_cosh_034_real128


    module procedure taylor_series_cosh_035_real128

        res = taylor_series_cosh_034_real128(x)

    end procedure taylor_series_cosh_035_real128


    module procedure taylor_series_cosh_036_real128

        res = horner_035( x = x, pre_step = coefficient_036 )

    end procedure taylor_series_cosh_036_real128


    module procedure taylor_series_cosh_037_real128

        res = taylor_series_cosh_036_real128(x)

    end procedure taylor_series_cosh_037_real128


    module procedure taylor_series_cosh_038_real128

        res = horner_037( x = x, pre_step = coefficient_038 )

    end procedure taylor_series_cosh_038_real128


    module procedure taylor_series_cosh_039_real128

        res = taylor_series_cosh_038_real128(x)

    end procedure taylor_series_cosh_039_real128


    module procedure taylor_series_cosh_040_real128

        res = horner_039( x = x, pre_step = coefficient_040 )

    end procedure taylor_series_cosh_040_real128


    module procedure taylor_series_cosh_041_real128

        res = taylor_series_cosh_040_real128(x)

    end procedure taylor_series_cosh_041_real128


    module procedure taylor_series_cosh_042_real128

        res = horner_041( x = x, pre_step = coefficient_042 )

    end procedure taylor_series_cosh_042_real128


    module procedure taylor_series_cosh_043_real128

        res = taylor_series_cosh_042_real128(x)

    end procedure taylor_series_cosh_043_real128


    module procedure taylor_series_cosh_044_real128

        res = horner_043( x = x, pre_step = coefficient_044 )

    end procedure taylor_series_cosh_044_real128


    module procedure taylor_series_cosh_045_real128

        res = taylor_series_cosh_044_real128(x)

    end procedure taylor_series_cosh_045_real128


    module procedure taylor_series_cosh_046_real128

        res = horner_045( x = x, pre_step = coefficient_046 )

    end procedure taylor_series_cosh_046_real128


    module procedure taylor_series_cosh_047_real128

        res = taylor_series_cosh_046_real128(x)

    end procedure taylor_series_cosh_047_real128


    module procedure taylor_series_cosh_048_real128

        res = horner_047( x = x, pre_step = coefficient_048 )

    end procedure taylor_series_cosh_048_real128


    module procedure taylor_series_cosh_049_real128

        res = taylor_series_cosh_048_real128(x)

    end procedure taylor_series_cosh_049_real128


    module procedure taylor_series_cosh_050_real128

        res = horner_049( x = x, pre_step = coefficient_050 )

    end procedure taylor_series_cosh_050_real128


    module procedure taylor_series_cosh_051_real128

        res = taylor_series_cosh_050_real128(x)

    end procedure taylor_series_cosh_051_real128


    module procedure taylor_series_cosh_052_real128

        res = horner_051( x = x, pre_step = coefficient_052 )

    end procedure taylor_series_cosh_052_real128


    module procedure taylor_series_cosh_053_real128

        res = taylor_series_cosh_052_real128(x)

    end procedure taylor_series_cosh_053_real128


    module procedure taylor_series_cosh_054_real128

        res = horner_053( x = x, pre_step = coefficient_054 )

    end procedure taylor_series_cosh_054_real128


    module procedure taylor_series_cosh_055_real128

        res = taylor_series_cosh_054_real128(x)

    end procedure taylor_series_cosh_055_real128


    module procedure taylor_series_cosh_056_real128

        res = horner_055( x = x, pre_step = coefficient_056 )

    end procedure taylor_series_cosh_056_real128


    module procedure taylor_series_cosh_057_real128

        res = taylor_series_cosh_056_real128(x)

    end procedure taylor_series_cosh_057_real128


    module procedure taylor_series_cosh_058_real128

        res = horner_057( x = x, pre_step = coefficient_058 )

    end procedure taylor_series_cosh_058_real128


    module procedure taylor_series_cosh_059_real128

        res = taylor_series_cosh_058_real128(x)

    end procedure taylor_series_cosh_059_real128


    module procedure taylor_series_cosh_060_real128

        res = horner_059( x = x, pre_step = coefficient_060 )

    end procedure taylor_series_cosh_060_real128


    module procedure taylor_series_cosh_061_real128

        res = taylor_series_cosh_060_real128(x)

    end procedure taylor_series_cosh_061_real128


    module procedure taylor_series_cosh_062_real128

        res = horner_061( x = x, pre_step = coefficient_062 )

    end procedure taylor_series_cosh_062_real128


    module procedure taylor_series_cosh_063_real128

        res = taylor_series_cosh_062_real128(x)

    end procedure taylor_series_cosh_063_real128


    module procedure taylor_series_cosh_064_real128

        res = horner_063( x = x, pre_step = coefficient_064 )

    end procedure taylor_series_cosh_064_real128


    module procedure taylor_series_cosh_065_real128

        res = taylor_series_cosh_064_real128(x)

    end procedure taylor_series_cosh_065_real128


    module procedure taylor_series_cosh_066_real128

        res = horner_065( x = x, pre_step = coefficient_066 )

    end procedure taylor_series_cosh_066_real128


    module procedure taylor_series_cosh_067_real128

        res = taylor_series_cosh_066_real128(x)

    end procedure taylor_series_cosh_067_real128


    module procedure taylor_series_cosh_068_real128

        res = horner_067( x = x, pre_step = coefficient_068 )

    end procedure taylor_series_cosh_068_real128


    module procedure taylor_series_cosh_069_real128

        res = taylor_series_cosh_068_real128(x)

    end procedure taylor_series_cosh_069_real128


    module procedure taylor_series_cosh_070_real128

        res = horner_069( x = x, pre_step = coefficient_070 )

    end procedure taylor_series_cosh_070_real128


    module procedure taylor_series_cosh_071_real128

        res = taylor_series_cosh_070_real128(x)

    end procedure taylor_series_cosh_071_real128


    module procedure taylor_series_cosh_072_real128

        res = horner_071( x = x, pre_step = coefficient_072 )

    end procedure taylor_series_cosh_072_real128


    module procedure taylor_series_cosh_073_real128

        res = taylor_series_cosh_072_real128(x)

    end procedure taylor_series_cosh_073_real128


    module procedure taylor_series_cosh_074_real128

        res = horner_073( x = x, pre_step = coefficient_074 )

    end procedure taylor_series_cosh_074_real128


    module procedure taylor_series_cosh_075_real128

        res = taylor_series_cosh_074_real128(x)

    end procedure taylor_series_cosh_075_real128


    module procedure taylor_series_cosh_076_real128

        res = horner_075( x = x, pre_step = coefficient_076 )

    end procedure taylor_series_cosh_076_real128


    module procedure taylor_series_cosh_077_real128

        res = taylor_series_cosh_076_real128(x)

    end procedure taylor_series_cosh_077_real128


    module procedure taylor_series_cosh_078_real128

        res = horner_077( x = x, pre_step = coefficient_078 )

    end procedure taylor_series_cosh_078_real128


    module procedure taylor_series_cosh_079_real128

        res = taylor_series_cosh_078_real128(x)

    end procedure taylor_series_cosh_079_real128


    module procedure taylor_series_cosh_080_real128

        res = horner_079( x = x, pre_step = coefficient_080 )

    end procedure taylor_series_cosh_080_real128


    module procedure taylor_series_cosh_081_real128

        res = taylor_series_cosh_080_real128(x)

    end procedure taylor_series_cosh_081_real128


    module procedure taylor_series_cosh_082_real128

        res = horner_081( x = x, pre_step = coefficient_082 )

    end procedure taylor_series_cosh_082_real128


    module procedure taylor_series_cosh_083_real128

        res = taylor_series_cosh_082_real128(x)

    end procedure taylor_series_cosh_083_real128


    module procedure taylor_series_cosh_084_real128

        res = horner_083( x = x, pre_step = coefficient_084 )

    end procedure taylor_series_cosh_084_real128


    module procedure taylor_series_cosh_085_real128

        res = taylor_series_cosh_084_real128(x)

    end procedure taylor_series_cosh_085_real128


    module procedure taylor_series_cosh_086_real128

        res = horner_085( x = x, pre_step = coefficient_086 )

    end procedure taylor_series_cosh_086_real128


    module procedure taylor_series_cosh_087_real128

        res = taylor_series_cosh_086_real128(x)

    end procedure taylor_series_cosh_087_real128


    module procedure taylor_series_cosh_088_real128

        res = horner_087( x = x, pre_step = coefficient_088 )

    end procedure taylor_series_cosh_088_real128


    module procedure taylor_series_cosh_089_real128

        res = taylor_series_cosh_088_real128(x)

    end procedure taylor_series_cosh_089_real128


    module procedure taylor_series_cosh_090_real128

        res = horner_089( x = x, pre_step = coefficient_090 )

    end procedure taylor_series_cosh_090_real128


    module procedure taylor_series_cosh_091_real128

        res = taylor_series_cosh_090_real128(x)

    end procedure taylor_series_cosh_091_real128


    module procedure taylor_series_cosh_092_real128

        res = horner_091( x = x, pre_step = coefficient_092 )

    end procedure taylor_series_cosh_092_real128


    module procedure taylor_series_cosh_093_real128

        res = taylor_series_cosh_092_real128(x)

    end procedure taylor_series_cosh_093_real128


    module procedure taylor_series_cosh_094_real128

        res = horner_093( x = x, pre_step = coefficient_094 )

    end procedure taylor_series_cosh_094_real128


    module procedure taylor_series_cosh_095_real128

        res = taylor_series_cosh_094_real128(x)

    end procedure taylor_series_cosh_095_real128


    module procedure taylor_series_cosh_096_real128

        res = horner_095( x = x, pre_step = coefficient_096 )

    end procedure taylor_series_cosh_096_real128


    module procedure taylor_series_cosh_097_real128

        res = taylor_series_cosh_096_real128(x)

    end procedure taylor_series_cosh_097_real128


    module procedure taylor_series_cosh_098_real128

        res = horner_097( x = x, pre_step = coefficient_098 )

    end procedure taylor_series_cosh_098_real128


    module procedure taylor_series_cosh_099_real128

        res = taylor_series_cosh_098_real128(x)

    end procedure taylor_series_cosh_099_real128


    module procedure taylor_series_cosh_100_real128

        res = horner_099( x = x, pre_step = coefficient_100 )

    end procedure taylor_series_cosh_100_real128


    module procedure taylor_series_cosh_101_real128

        res = taylor_series_cosh_100_real128(x)

    end procedure taylor_series_cosh_101_real128


    module procedure taylor_series_cosh_102_real128

        res = horner_101( x = x, pre_step = coefficient_102 )

    end procedure taylor_series_cosh_102_real128


    module procedure taylor_series_cosh_103_real128

        res = taylor_series_cosh_102_real128(x)

    end procedure taylor_series_cosh_103_real128


    module procedure taylor_series_cosh_104_real128

        res = horner_103( x = x, pre_step = coefficient_104 )

    end procedure taylor_series_cosh_104_real128


    module procedure taylor_series_cosh_105_real128

        res = taylor_series_cosh_104_real128(x)

    end procedure taylor_series_cosh_105_real128


    module procedure taylor_series_cosh_106_real128

        res = horner_105( x = x, pre_step = coefficient_106 )

    end procedure taylor_series_cosh_106_real128


    module procedure taylor_series_cosh_107_real128

        res = taylor_series_cosh_106_real128(x)

    end procedure taylor_series_cosh_107_real128


    module procedure taylor_series_cosh_108_real128

        res = horner_107( x = x, pre_step = coefficient_108 )

    end procedure taylor_series_cosh_108_real128


    module procedure taylor_series_cosh_109_real128

        res = taylor_series_cosh_108_real128(x)

    end procedure taylor_series_cosh_109_real128


    module procedure taylor_series_cosh_110_real128

        res = horner_109( x = x, pre_step = coefficient_110 )

    end procedure taylor_series_cosh_110_real128


    module procedure taylor_series_cosh_111_real128

        res = taylor_series_cosh_110_real128(x)

    end procedure taylor_series_cosh_111_real128


    module procedure taylor_series_cosh_112_real128

        res = horner_111( x = x, pre_step = coefficient_112 )

    end procedure taylor_series_cosh_112_real128


    module procedure taylor_series_cosh_113_real128

        res = taylor_series_cosh_112_real128(x)

    end procedure taylor_series_cosh_113_real128


    module procedure taylor_series_cosh_114_real128

        res = horner_113( x = x, pre_step = coefficient_114 )

    end procedure taylor_series_cosh_114_real128


    module procedure taylor_series_cosh_115_real128

        res = taylor_series_cosh_114_real128(x)

    end procedure taylor_series_cosh_115_real128


    module procedure taylor_series_cosh_116_real128

        res = horner_115( x = x, pre_step = coefficient_116 )

    end procedure taylor_series_cosh_116_real128


    module procedure taylor_series_cosh_117_real128

        res = taylor_series_cosh_116_real128(x)

    end procedure taylor_series_cosh_117_real128


    module procedure taylor_series_cosh_118_real128

        res = horner_117( x = x, pre_step = coefficient_118 )

    end procedure taylor_series_cosh_118_real128


    module procedure taylor_series_cosh_119_real128

        res = taylor_series_cosh_118_real128(x)

    end procedure taylor_series_cosh_119_real128


    module procedure taylor_series_cosh_120_real128

        res = horner_119( x = x, pre_step = coefficient_120 )

    end procedure taylor_series_cosh_120_real128


    module procedure taylor_series_cosh_121_real128

        res = taylor_series_cosh_120_real128(x)

    end procedure taylor_series_cosh_121_real128


    module procedure taylor_series_cosh_122_real128

        res = horner_121( x = x, pre_step = coefficient_122 )

    end procedure taylor_series_cosh_122_real128


    module procedure taylor_series_cosh_123_real128

        res = taylor_series_cosh_122_real128(x)

    end procedure taylor_series_cosh_123_real128


    module procedure taylor_series_cosh_124_real128

        res = horner_123( x = x, pre_step = coefficient_124 )

    end procedure taylor_series_cosh_124_real128


    module procedure taylor_series_cosh_125_real128

        res = taylor_series_cosh_124_real128(x)

    end procedure taylor_series_cosh_125_real128


    module procedure taylor_series_cosh_126_real128

        res = horner_125( x = x, pre_step = coefficient_126 )

    end procedure taylor_series_cosh_126_real128


    module procedure taylor_series_cosh_127_real128

        res = taylor_series_cosh_126_real128(x)

    end procedure taylor_series_cosh_127_real128


    module procedure taylor_series_cosh_128_real128

        res = horner_127( x = x, pre_step = coefficient_128 )

    end procedure taylor_series_cosh_128_real128


    module procedure taylor_series_cosh_129_real128

        res = taylor_series_cosh_128_real128(x)

    end procedure taylor_series_cosh_129_real128


    module procedure taylor_series_cosh_130_real128

        res = horner_129( x = x, pre_step = coefficient_130 )

    end procedure taylor_series_cosh_130_real128


    module procedure taylor_series_cosh_131_real128

        res = taylor_series_cosh_130_real128(x)

    end procedure taylor_series_cosh_131_real128


    module procedure taylor_series_cosh_132_real128

        res = horner_131( x = x, pre_step = coefficient_132 )

    end procedure taylor_series_cosh_132_real128


    module procedure taylor_series_cosh_133_real128

        res = taylor_series_cosh_132_real128(x)

    end procedure taylor_series_cosh_133_real128


    module procedure taylor_series_cosh_134_real128

        res = horner_133( x = x, pre_step = coefficient_134 )

    end procedure taylor_series_cosh_134_real128


    module procedure taylor_series_cosh_135_real128

        res = taylor_series_cosh_134_real128(x)

    end procedure taylor_series_cosh_135_real128


    module procedure taylor_series_cosh_136_real128

        res = horner_135( x = x, pre_step = coefficient_136 )

    end procedure taylor_series_cosh_136_real128


    module procedure taylor_series_cosh_137_real128

        res = taylor_series_cosh_136_real128(x)

    end procedure taylor_series_cosh_137_real128


    module procedure taylor_series_cosh_138_real128

        res = horner_137( x = x, pre_step = coefficient_138 )

    end procedure taylor_series_cosh_138_real128


    module procedure taylor_series_cosh_139_real128

        res = taylor_series_cosh_138_real128(x)

    end procedure taylor_series_cosh_139_real128


    module procedure taylor_series_cosh_140_real128

        res = horner_139( x = x, pre_step = coefficient_140 )

    end procedure taylor_series_cosh_140_real128


    module procedure taylor_series_cosh_141_real128

        res = taylor_series_cosh_140_real128(x)

    end procedure taylor_series_cosh_141_real128


    module procedure taylor_series_cosh_142_real128

        res = horner_141( x = x, pre_step = coefficient_142 )

    end procedure taylor_series_cosh_142_real128


    module procedure taylor_series_cosh_143_real128

        res = taylor_series_cosh_142_real128(x)

    end procedure taylor_series_cosh_143_real128


    module procedure taylor_series_cosh_144_real128

        res = horner_143( x = x, pre_step = coefficient_144 )

    end procedure taylor_series_cosh_144_real128


    module procedure taylor_series_cosh_145_real128

        res = taylor_series_cosh_144_real128(x)

    end procedure taylor_series_cosh_145_real128


    module procedure taylor_series_cosh_146_real128

        res = horner_145( x = x, pre_step = coefficient_146 )

    end procedure taylor_series_cosh_146_real128


    module procedure taylor_series_cosh_147_real128

        res = taylor_series_cosh_146_real128(x)

    end procedure taylor_series_cosh_147_real128


    module procedure taylor_series_cosh_148_real128

        res = horner_147( x = x, pre_step = coefficient_148 )

    end procedure taylor_series_cosh_148_real128


    module procedure taylor_series_cosh_149_real128

        res = taylor_series_cosh_148_real128(x)

    end procedure taylor_series_cosh_149_real128


    module procedure taylor_series_cosh_150_real128

        res = horner_149( x = x, pre_step = coefficient_150 )

    end procedure taylor_series_cosh_150_real128


    module procedure taylor_series_cosh_151_real128

        res = taylor_series_cosh_150_real128(x)

    end procedure taylor_series_cosh_151_real128


    module procedure taylor_series_cosh_152_real128

        res = horner_151( x = x, pre_step = coefficient_152 )

    end procedure taylor_series_cosh_152_real128


    module procedure taylor_series_cosh_153_real128

        res = taylor_series_cosh_152_real128(x)

    end procedure taylor_series_cosh_153_real128


    module procedure taylor_series_cosh_154_real128

        res = horner_153( x = x, pre_step = coefficient_154 )

    end procedure taylor_series_cosh_154_real128


    module procedure taylor_series_cosh_155_real128

        res = taylor_series_cosh_154_real128(x)

    end procedure taylor_series_cosh_155_real128


    module procedure taylor_series_cosh_156_real128

        res = horner_155( x = x, pre_step = coefficient_156 )

    end procedure taylor_series_cosh_156_real128


    module procedure taylor_series_cosh_157_real128

        res = taylor_series_cosh_156_real128(x)

    end procedure taylor_series_cosh_157_real128


    module procedure taylor_series_cosh_158_real128

        res = horner_157( x = x, pre_step = coefficient_158 )

    end procedure taylor_series_cosh_158_real128


    module procedure taylor_series_cosh_159_real128

        res = taylor_series_cosh_158_real128(x)

    end procedure taylor_series_cosh_159_real128


    module procedure taylor_series_cosh_160_real128

        res = horner_159( x = x, pre_step = coefficient_160 )

    end procedure taylor_series_cosh_160_real128


    module procedure taylor_series_cosh_161_real128

        res = taylor_series_cosh_160_real128(x)

    end procedure taylor_series_cosh_161_real128


    module procedure taylor_series_cosh_162_real128

        res = horner_161( x = x, pre_step = coefficient_162 )

    end procedure taylor_series_cosh_162_real128


    module procedure taylor_series_cosh_163_real128

        res = taylor_series_cosh_162_real128(x)

    end procedure taylor_series_cosh_163_real128


    module procedure taylor_series_cosh_164_real128

        res = horner_163( x = x, pre_step = coefficient_164 )

    end procedure taylor_series_cosh_164_real128


    module procedure taylor_series_cosh_165_real128

        res = taylor_series_cosh_164_real128(x)

    end procedure taylor_series_cosh_165_real128


    module procedure taylor_series_cosh_166_real128

        res = horner_165( x = x, pre_step = coefficient_166 )

    end procedure taylor_series_cosh_166_real128


    module procedure taylor_series_cosh_167_real128

        res = taylor_series_cosh_166_real128(x)

    end procedure taylor_series_cosh_167_real128


    module procedure taylor_series_cosh_168_real128

        res = horner_167( x = x, pre_step = coefficient_168 )

    end procedure taylor_series_cosh_168_real128


    module procedure taylor_series_cosh_169_real128

        res = taylor_series_cosh_168_real128(x)

    end procedure taylor_series_cosh_169_real128


    module procedure taylor_series_cosh_170_real128

        res = horner_169( x = x, pre_step = coefficient_170 )

    end procedure taylor_series_cosh_170_real128


    module procedure taylor_series_cosh_171_real128

        res = taylor_series_cosh_170_real128(x)

    end procedure taylor_series_cosh_171_real128


    module procedure taylor_series_cosh_172_real128

        res = horner_171( x = x, pre_step = coefficient_172 )

    end procedure taylor_series_cosh_172_real128


    module procedure taylor_series_cosh_173_real128

        res = taylor_series_cosh_172_real128(x)

    end procedure taylor_series_cosh_173_real128


    module procedure taylor_series_cosh_174_real128

        res = horner_173( x = x, pre_step = coefficient_174 )

    end procedure taylor_series_cosh_174_real128


    module procedure taylor_series_cosh_175_real128

        res = taylor_series_cosh_174_real128(x)

    end procedure taylor_series_cosh_175_real128


    module procedure taylor_series_cosh_176_real128

        res = horner_175( x = x, pre_step = coefficient_176 )

    end procedure taylor_series_cosh_176_real128
...
end submodule imp_taylor_series_cosh_real128
