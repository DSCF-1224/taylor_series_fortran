!> Implementation of `taylor_series_cosh_***` for `real32`.
!! @note
!! [main_submodule_cosh_real32.f90](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/src/main_submodule_cosh_real32.f90)
!! [demo_cosh_error_real32.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_cosh_error_real32.svg)
!! [demo_cosh_series_real32.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_cosh_series_real32.svg)
!! @endnote
submodule (taylor_series_fortran) imp_taylor_series_cosh_real32
    ...
    module procedure taylor_series_cosh_000_real32

        res = horner_000( x = x, pre_step = 0.0_real32 )

    end procedure taylor_series_cosh_000_real32


    module procedure taylor_series_cosh_001_real32

        res = taylor_series_cosh_000_real32(x)

    end procedure taylor_series_cosh_001_real32


    module procedure taylor_series_cosh_002_real32

        res = horner_001( x = x, pre_step = coefficient_002 )

    end procedure taylor_series_cosh_002_real32


    module procedure taylor_series_cosh_003_real32

        res = taylor_series_cosh_002_real32(x)

    end procedure taylor_series_cosh_003_real32


    module procedure taylor_series_cosh_004_real32

        res = horner_003( x = x, pre_step = coefficient_004 )

    end procedure taylor_series_cosh_004_real32


    module procedure taylor_series_cosh_005_real32

        res = taylor_series_cosh_004_real32(x)

    end procedure taylor_series_cosh_005_real32


    module procedure taylor_series_cosh_006_real32

        res = horner_005( x = x, pre_step = coefficient_006 )

    end procedure taylor_series_cosh_006_real32


    module procedure taylor_series_cosh_007_real32

        res = taylor_series_cosh_006_real32(x)

    end procedure taylor_series_cosh_007_real32


    module procedure taylor_series_cosh_008_real32

        res = horner_007( x = x, pre_step = coefficient_008 )

    end procedure taylor_series_cosh_008_real32


    module procedure taylor_series_cosh_009_real32

        res = taylor_series_cosh_008_real32(x)

    end procedure taylor_series_cosh_009_real32


    module procedure taylor_series_cosh_010_real32

        res = horner_009( x = x, pre_step = coefficient_010 )

    end procedure taylor_series_cosh_010_real32


    module procedure taylor_series_cosh_011_real32

        res = taylor_series_cosh_010_real32(x)

    end procedure taylor_series_cosh_011_real32


    module procedure taylor_series_cosh_012_real32

        res = horner_011( x = x, pre_step = coefficient_012 )

    end procedure taylor_series_cosh_012_real32


    module procedure taylor_series_cosh_013_real32

        res = taylor_series_cosh_012_real32(x)

    end procedure taylor_series_cosh_013_real32


    module procedure taylor_series_cosh_014_real32

        res = horner_013( x = x, pre_step = coefficient_014 )

    end procedure taylor_series_cosh_014_real32


    module procedure taylor_series_cosh_015_real32

        res = taylor_series_cosh_014_real32(x)

    end procedure taylor_series_cosh_015_real32


    module procedure taylor_series_cosh_016_real32

        res = horner_015( x = x, pre_step = coefficient_016 )

    end procedure taylor_series_cosh_016_real32


    module procedure taylor_series_cosh_017_real32

        res = taylor_series_cosh_016_real32(x)

    end procedure taylor_series_cosh_017_real32


    module procedure taylor_series_cosh_018_real32

        res = horner_017( x = x, pre_step = coefficient_018 )

    end procedure taylor_series_cosh_018_real32


    module procedure taylor_series_cosh_019_real32

        res = taylor_series_cosh_018_real32(x)

    end procedure taylor_series_cosh_019_real32


    module procedure taylor_series_cosh_020_real32

        res = horner_019( x = x, pre_step = coefficient_020 )

    end procedure taylor_series_cosh_020_real32


    module procedure taylor_series_cosh_021_real32

        res = taylor_series_cosh_020_real32(x)

    end procedure taylor_series_cosh_021_real32


    module procedure taylor_series_cosh_022_real32

        res = horner_021( x = x, pre_step = coefficient_022 )

    end procedure taylor_series_cosh_022_real32


    module procedure taylor_series_cosh_023_real32

        res = taylor_series_cosh_022_real32(x)

    end procedure taylor_series_cosh_023_real32


    module procedure taylor_series_cosh_024_real32

        res = horner_023( x = x, pre_step = coefficient_024 )

    end procedure taylor_series_cosh_024_real32


    module procedure taylor_series_cosh_025_real32

        res = taylor_series_cosh_024_real32(x)

    end procedure taylor_series_cosh_025_real32


    module procedure taylor_series_cosh_026_real32

        res = horner_025( x = x, pre_step = coefficient_026 )

    end procedure taylor_series_cosh_026_real32


    module procedure taylor_series_cosh_027_real32

        res = taylor_series_cosh_026_real32(x)

    end procedure taylor_series_cosh_027_real32


    module procedure taylor_series_cosh_028_real32

        res = horner_027( x = x, pre_step = coefficient_028 )

    end procedure taylor_series_cosh_028_real32


    module procedure taylor_series_cosh_029_real32

        res = taylor_series_cosh_028_real32(x)

    end procedure taylor_series_cosh_029_real32


    module procedure taylor_series_cosh_030_real32

        res = horner_029( x = x, pre_step = coefficient_030 )

    end procedure taylor_series_cosh_030_real32


    module procedure taylor_series_cosh_031_real32

        res = taylor_series_cosh_030_real32(x)

    end procedure taylor_series_cosh_031_real32


    module procedure taylor_series_cosh_032_real32

        res = horner_031( x = x, pre_step = coefficient_032 )

    end procedure taylor_series_cosh_032_real32


    module procedure taylor_series_cosh_033_real32

        res = taylor_series_cosh_032_real32(x)

    end procedure taylor_series_cosh_033_real32


    module procedure taylor_series_cosh_034_real32

        res = horner_033( x = x, pre_step = coefficient_034 )

    end procedure taylor_series_cosh_034_real32


    module procedure taylor_series_cosh_035_real32

        res = taylor_series_cosh_034_real32(x)

    end procedure taylor_series_cosh_035_real32


    module procedure taylor_series_cosh_036_real32

        res = horner_035( x = x, pre_step = coefficient_036 )

    end procedure taylor_series_cosh_036_real32


    module procedure taylor_series_cosh_037_real32

        res = taylor_series_cosh_036_real32(x)

    end procedure taylor_series_cosh_037_real32


    module procedure taylor_series_cosh_038_real32

        res = horner_037( x = x, pre_step = coefficient_038 )

    end procedure taylor_series_cosh_038_real32
...
end submodule imp_taylor_series_cosh_real32
