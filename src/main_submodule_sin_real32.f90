...
!! @note
!! [main_submodule_sin_real32.f90](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/src/main_submodule_sin_real32.f90)
!! [demo_sin_error_real32.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_sin_error_real32.svg)
!! [demo_sin_series_real32.svg](https://github.com/DSCF-1224/taylor_series_fortran/blob/github-pages/example/demo_sin_series_real32.svg)
!! @endnote
